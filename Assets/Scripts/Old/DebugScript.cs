...
public class DebugScript : MonoBehaviour {
	...
	void Update () {
		if(Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1))
		{
			...
			Camera.main.GetComponent<CameraMovement>().MoveCamera(pD.cameraPositions[0].x, pD.cameraPositions[0].y, pD.cameraPositions[0].z, false, false, 0);
		...
		if(Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2))
		{
			...
			Camera.main.GetComponent<CameraMovement>().MoveCamera(pD.cameraPositions[3].x, pD.cameraPositions[3].y, pD.cameraPositions[3].z, false, false, 0);
			for(int i = 0; i < cameraEdges.Length; i++)
			{
				if(i == 5)
				{
		...
		if(Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3))
		{
			...
			Camera.main.GetComponent<CameraMovement>().MoveCamera(pD.cameraPositions[4].x, pD.cameraPositions[4].y, pD.cameraPositions[4].z, false, false, 0);
			for(int i = 0; i < cameraEdges.Length; i++)
			{
				if(i == 7 || i == 8)
				{
		...
		if(Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Keypad4))
		{
			...
			Camera.main.GetComponent<CameraMovement>().MoveCamera(pD.cameraPositions[7].x, pD.cameraPositions[7].y, pD.cameraPositions[7].z, false, false, 0);
			for(int i = 0; i < cameraEdges.Length; i++)
			{
				if(i == 13 || i == 14)
				{
